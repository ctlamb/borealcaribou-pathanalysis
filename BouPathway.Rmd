...
##Find intersections
```{r Find intersections with error}
#bootstrap errors
int.data <- data.frame()
for(i in 1:1000){
...
##Plot raw data
```{r plot raw data, fig.height=5, fig.width=9.5, message=FALSE, warning=FALSE}
...
ggsave(here::here("plots","univar.png"), width=9.5, height=5, units="in",dpi=800)
ggsave(here::here("plots","univar.pdf"), width=9.5, height=5, units="in")
...
##Plot paths
```{r Plot paths, fig.height=3.5, fig.width=9, message=FALSE, warning=FALSE}
dag.dat <- data.frame()
